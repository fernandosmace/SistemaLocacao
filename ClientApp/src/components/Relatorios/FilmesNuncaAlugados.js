...
import { getFilmesNuncaAlugados } from "../../services/RelatoriosService";
import { EyeTwoTone } from "@ant-design/icons";
import swal from "sweetalert";

const FilmesNuncaAlugados = () => {
  const [filmes, setFilmes] = useState([]);

  useEffect(() => {
    getFilmesNuncaAlugados().then((response) => {
...
export default FilmesNuncaAlugados;
