...
import { getFilmesMenosAlugadosSemana } from "../../services/RelatoriosService";
import { EyeTwoTone } from "@ant-design/icons";
import swal from "sweetalert";

const FilmesMenosAlugadosSemana = () => {
  const [filmes, setFilmes] = useState([]);

  useEffect(() => {
    getFilmesMenosAlugadosSemana().then((response) => {
...
export default FilmesMenosAlugadosSemana;
